...
export class authController {
    static async postCreerUtilisateur(req: Request, res: Response): Promise<{ success: boolean; message: string }> {
        ...
        try {
            ...
            return { success: false, message: "Erreur interne lors de la création de l'utilisateur." };
        }
    }
